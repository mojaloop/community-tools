...
current_dir="/home/ec2-user/test/start/community-tools/oss-stats/dependency"
cd $current_dir

#Cloning the repositories
rm -rf /home/ec2-user/test/start/cloned-repos/* 
cd /home/ec2-user/test/start/cloned-repos
bash ../community-tools/oss-stats/dependency/clone-repos.sh 
cd $current_dir

#Generate sboms for all repos 
rm -rf /home/ec2-user/test/start/sboms/* 
cd /home/ec2-user/test/start/cloned-repos
bash /home/ec2-user/test/start/community-tools/oss-stats/generate-sboms.sh 
cd $current_dir
...
rm /home/ec2-user/test/start/community-tools/oss-stats/dependency/dependencies-services-last-publish.csv
rm /home/ec2-user/test/start/community-tools/oss-stats/dependency/dependency-services.csv
